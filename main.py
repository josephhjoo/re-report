...
from utils import process_csv_and_get_metrics, call_gpt_structured, build_pdf, generate_charts, current_week_label
...
def analyze():
    try:
        ...
        gpt_json = call_gpt_structured(metrics)
        ...
        build_pdf(agent_name, week_label, metrics, charts, gpt_json, pdf_path)
